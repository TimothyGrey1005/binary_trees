...
/**
 * bal - Measure the balance factor AVL
...
/**
 * successor - Next successor i mean the min node in right subtree
 * @node: the tree to check
 * Return: min value of a tree
 */
 ...
 *Return: 0 if no children or other value it has
 */
...
/**
 * bst_remove - removes node from BST tree
 * @root: root of tree
