 ...
 * @head: Pointer to head of linked list and nodes at one level.
 * @func: Pointer to function call for each node.
 */
void levels_rec(ll *head, void (*func)(int))
{
...
/**
 * get_children - appends children of parent to the linked list.
 * @head: Pointer to head of the linked list where children are appended.
 * @parent: Pointer to node whose children we append.
 * Return: Pointer to head of the linked list of children.
 */
ll *get_children(ll *head, const binary_tree_t *parent)
{
	if (parent->left)
...
/**
 * append - adds new node to the end of linkedlist
